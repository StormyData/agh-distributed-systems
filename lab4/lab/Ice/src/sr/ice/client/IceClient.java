...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base1 = communicator.propertyToProxy("Calc1.Proxy");//.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości
				...
				try {
					...
					switch (line) {
						...
						case "throw":
							...
							break;
						case "avg":
							System.out.println(obj1.avg(new long[]{1, 3, 5, 7}));
							break;
						default:
							System.out.println("???");
					}
				} catch (IOException | TwowayOnlyException | NoInput ex) {
