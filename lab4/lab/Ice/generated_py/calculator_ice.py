...
if '_t_slong' not in _M_Demo.__dict__:
    _M_Demo._t_slong = IcePy.defineSequence('::Demo::slong', (), IcePy._t_long)
...
if 'CalcPrx' not in _M_Demo.__dict__:
    ...
    class CalcPrx(Ice.ObjectPrx):
        ...
        def avg(self, seq, context=None):
            return _M_Demo.Calc._op_avg.invoke(self, ((seq, ), context))

        def avgAsync(self, seq, context=None):
            return _M_Demo.Calc._op_avg.invokeAsync(self, ((seq, ), context))

        def begin_avg(self, seq, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Calc._op_avg.begin(self, ((seq, ), _response, _ex, _sent, context))
    ...
    Calc._op_avg = IcePy.Operation('avg', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), _M_Demo._t_slong, False, 0),), (), ((), IcePy._t_double, False, 0), (_M_Demo._t_NoInput,))
